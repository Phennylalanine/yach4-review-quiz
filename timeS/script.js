...
function saveProgress() {
  localStorage.setItem("timeSxp", xp);
  localStorage.setItem("timeSlevel", level);
}

function loadProgress() {
  const savedXP = localStorage.getItem("timeSxp");
  const savedLevel = localStorage.getItem("timeSlevel");
