...
window.addEventListener("DOMContentLoaded", () => {
  ...
  function saveProgress() {
    localStorage.setItem("daySxp", xp);
    localStorage.setItem("daySlevel", level);
  }

  function loadProgress() {
    const savedXP = localStorage.getItem("daySxp");
    const savedLevel = localStorage.getItem("daySlevel");
