...
function saveProgress() {
  localStorage.setItem("dayMxp", xp);
  localStorage.setItem("dayMlevel", level);
}

function loadProgress() {
  const savedXP = localStorage.getItem("dayMxp");
  const savedLevel = localStorage.getItem("dayMlevel");
